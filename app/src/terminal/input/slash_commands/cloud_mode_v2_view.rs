...
impl Section {
    ...
    fn header_key(self) -> &'static str {
        match self {
            Self::Commands => "slash-section-commands",
            Self::Skills => "slash-section-skills",
            Self::Prompts => "slash-section-prompts",
        }
    }
...
fn render_show_more_row(
    ...
    let label = crate::localization::t_args(
        app,
        "slash-show-more",
